...
Poltergeist.WebPage = (function() {
  ...
  WebPage.CALLBACKS = ['onAlert', 'onConfirm', 'onPrompt', 'onConsoleMessage', 'onLoadFinished', 'onInitialized', 'onLoadStarted', 'onResourceRequested', 'onResourceReceived', 'onError', 'onNavigationRequested', 'onUrlChanged', 'onPageCreated'];
