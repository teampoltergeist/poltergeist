...
Poltergeist.WebPage = (function() {
  ...
  WebPage.prototype.evaluate = function() {
    ...
    this.injectAgent();
    result = (ref2 = this["native"]()).evaluate.apply(ref2, ["function() { for(var i=0; i < arguments.length; i++){ if ((typeof(arguments[i]) == 'object') && (typeof(arguments[i]['ELEMENT']) == 'object')){ arguments[i] = window.__poltergeist.get(arguments[i]['ELEMENT']['id']).element; } } var _result = " + (this.stringifyCall(fn)) + "; if (_result && _result.nodeType == 1 && _result['tagName']) { _result = {'ELEMENT': { id: window.__poltergeist.register(_result) } }; } return (_result == null) ? undefined : _result; }"].concat(slice.call(args)));
    if (result != null ? result['ELEMENT'] : void 0) {
      result['ELEMENT']['page_id'] = this.id;
    }
    return result;
  };
