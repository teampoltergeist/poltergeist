...
Poltergeist.WebPage = (function() {
  ...
  WebPage.CALLBACKS = ['onAlert', 'onConfirm', 'onConsoleMessage', 'onLoadFinished', 'onInitialized', 'onLoadStarted', 'onResourceRequested', 'onResourceReceived', 'onError', 'onNavigationRequested', 'onUrlChanged', 'onPageCreated', 'onClosing', 'onPrompt'];
