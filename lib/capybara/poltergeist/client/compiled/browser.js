(function() {
  ...
  Poltergeist.Browser = (function() {
    ...
    Browser.prototype.set_proxy = function(host, port) {
    ...
    Browser.prototype.push_frame = function(name, timeout) {
      var _ref,
        _this = this;
      if (timeout == null) timeout = new Date().getTime() + 2000;
    ...
    Browser.prototype.send_keys = function(page_id, id, keys) {
      ...
      if (!target.containsSelection()) target.mouseEvent('click');
    ...
    Browser.prototype.add_header = function(header, permanent) {
      if (!permanent) this.currentPage.addTempHeader(header);
