...
Poltergeist.Browser = (function() {
  ...
  Browser.prototype.resetPage = function() {
    ...
    this.prompt_messages = [];
    this.prompt_responses = [];
    return this.page.onPrompt = function(msg, defaultVal) {
      var val;
      _this.prompt_messages.push(msg);
      val = _this.prompt_responses.shift();
      if (val) {
        return val;
      }
      return defaultVal;
  ...
  Browser.prototype.js_prompt_messages = function() {
    this.sendResponse(this.prompt_messages);
    return this.prompt_messages = [];
  };

  Browser.prototype.set_js_prompt_responses = function(responses) {
    this.prompt_responses = responses;
    return this.sendResponse(true);
  };
