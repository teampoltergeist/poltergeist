Poltergeist.Browser = (function() {
  ...
  Browser.prototype.render_base64 = function(full, selector) {
    var _this = this;
    if (selector == null) {
      selector = null;
    }
    return this.render_clip(full, selector, function() {
      return _this.page.renderBase64();
    });
  };
  ...
  Browser.prototype.render = function(path, full, selector) {
    ...
    return this.render_clip(full, selector, function() {
      return _this.page.render(path);
    });
  };

  Browser.prototype.render_clip = function(full, selector, capture) {
    var dimensions, document, previous_clip, result, viewport;
